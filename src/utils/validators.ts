...
export const INVALID_PAGE_MESSAGE = 'O numéro de página passado é inválido. Tente novamente';
export const WITHOUT_USERS_MESSAGE = 'Não existe nenhum usuário cadastrado no sistema.';
